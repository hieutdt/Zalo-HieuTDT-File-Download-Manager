...
@property (nonatomic, strong) void (^completionHandler)(NSString *url, NSString *locationPath);
@property (nonatomic, strong) void (^errorHandler)(NSString *url, NSError *error);
